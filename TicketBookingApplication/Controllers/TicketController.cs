...
namespace TicketBookingApplication.Controllers
{
    public class TicketController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TicketTitle,From,To,Price")] Ticket ticket)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TicketTitle,From,To,Price")] Ticket ticket)
        {
            if (id != ticket.Id)
            {
                return NotFound();
